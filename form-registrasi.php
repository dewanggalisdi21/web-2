...
<form method="POST" action="hasil-form-regis.php" class="container mt-5">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124074" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="Dewangga Lisdi" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="progam_studi" class="col-4 col-form-label">Progam Studi</label> 
    <div class="col-8">
      <select id="progam_studi" name="progam_studi" class="custom-select" required="required">
        <?php
